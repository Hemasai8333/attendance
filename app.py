...
imgBackground=cv2.imread("background_i.png")
...
def register():
    ...
    return jsonify({"status": 200, "message": "User created successfully!", "data": None}), 201
...
def get_users():
    ...
    return jsonify({"status": 200, "message": "List of all the users", "data": users_list}), 200
